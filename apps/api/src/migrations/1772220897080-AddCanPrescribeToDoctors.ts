...
export class AddCanPrescribeToDoctors1772220897080 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE doctors ADD COLUMN IF NOT EXISTS can_prescribe TINYINT(1) DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE doctors ADD COLUMN IF NOT EXISTS approvalStatus VARCHAR(20) DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE doctors ADD COLUMN IF NOT EXISTS rejectionReason TEXT DEFAULT NULL`);
