...
export class SeedingService {
  ...
  async seedSettings() {
    const defaultSettings = [
      ...
      { key: 'FEE_NURSE_BASE_DAY', value: '3000', description: 'Nurse/Clinician Day Base Charge', isSecure: false },
      { key: 'FEE_NURSE_BASE_NIGHT', value: '5000', description: 'Nurse/Clinician Night Base Charge', isSecure: false },
      { key: 'FEE_DOCTOR_BASE_DAY', value: '7000', description: 'Doctor/Specialist Day Base Charge', isSecure: false },
      { key: 'FEE_DOCTOR_BASE_NIGHT', value: '10000', description: 'Doctor/Specialist Night Base Charge', isSecure: false },
